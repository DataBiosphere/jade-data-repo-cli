 ...
 */
@ApiModel(description = "The total number of studies available and a page of summaries ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-06-12T09:29:10.549-04:00")
public class EnumerateStudyModel {
  @JsonProperty("total")
  private Integer total = null;

  @JsonProperty("items")
  private List<StudySummaryModel> items = null;

  public EnumerateStudyModel total(Integer total) {
    this.total = total;
    return this;
  }
   ...
   * @return total
  **/
  @ApiModelProperty(value = "Total number of studies")
  ...
  public EnumerateStudyModel items(List<StudySummaryModel> items) {
    this.items = items;
    return this;
  }

  public EnumerateStudyModel addItemsItem(StudySummaryModel itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public List<StudySummaryModel> getItems() {
    return items;
  }

  public void setItems(List<StudySummaryModel> items) {
    this.items = items;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EnumerateStudyModel enumerateStudyModel = (EnumerateStudyModel) o;
    return Objects.equals(this.total, enumerateStudyModel.total) &&
        Objects.equals(this.items, enumerateStudyModel.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnumerateStudyModel {\n");
