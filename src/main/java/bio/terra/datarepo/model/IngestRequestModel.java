...
/**
 * Request to ingest data from a file in GCS into a table in a study. The ingest source must be readable by the DR manager. TODO: other input forms 
 */
@ApiModel(description = "Request to ingest data from a file in GCS into a table in a study. The ingest source must be readable by the DR manager. TODO: other input forms ")
...
public class IngestRequestModel {
  ...
  **/
  ...
  public IngestRequestModel loadTag(String loadTag) {
   ...
   /**
   * client-specified tag for this load. If no id is specified, we use the string form of the job create time as the tag. 
   * @return loadTag
  **/
  @ApiModelProperty(value = "client-specified tag for this load. If no id is specified, we use the string form of the job create time as the tag. ")
