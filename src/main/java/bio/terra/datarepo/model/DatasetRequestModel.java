...
import bio.terra.datarepo.model.DatasetRequestContentsModel;
...
/**
 * Request for creating a dataset. For now, the API only supports datasets defined as a single study asset and row ids for the root table of that asset. The dataset has exactly the tables and columns of the asset. An optional list of users can be provided to set as readers on the dataset. In the future, we will need to extend this to handle cross-study datasets from disparate assets, so we will need to support column and datatype mapping from asset tables to the target dataset tables. 
 */
@ApiModel(description = "Request for creating a dataset. For now, the API only supports datasets defined as a single study asset and row ids for the root table of that asset. The dataset has exactly the tables and columns of the asset. An optional list of users can be provided to set as readers on the dataset. In the future, we will need to extend this to handle cross-study datasets from disparate assets, so we will need to support column and datatype mapping from asset tables to the target dataset tables. ")
...
public class DatasetRequestModel {
  ...
  private List<DatasetRequestContentsModel> contents = new ArrayList<>();
  ...
  **/
  ...
  public DatasetRequestModel contents(List<DatasetRequestContentsModel> contents) {
    this.contents = contents;
    return this;
  }

  public DatasetRequestModel addContentsItem(DatasetRequestContentsModel contentsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "")
  public List<DatasetRequestContentsModel> getContents() {
    return contents;
  }

  public void setContents(List<DatasetRequestContentsModel> contents) {
    this.contents = contents;
  }

  public DatasetRequestModel readers(List<String> readers) {
    this.readers = readers;
    return this;
  }

  public DatasetRequestModel addReadersItem(String readersItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, datasetRequestModel.name) &&
        ...
        Objects.equals(this.contents, datasetRequestModel.contents) &&
        Objects.equals(this.readers, datasetRequestModel.readers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, contents, readers);
  }
