...
/**
 * One relationship between two tables. Captures a specific relationship between two tables. By naming the relationships, we can define assets. It should allow us to use the cardinality of the relationships to form proper views (INNER vs OUTER) and implement data validation. 
 */
@ApiModel(description = "One relationship between two tables. Captures a specific relationship between two tables. By naming the relationships, we can define assets. It should allow us to use the cardinality of the relationships to form proper views (INNER vs OUTER) and implement data validation. ")
