...
import bio.terra.datarepo.model.DatasetRequestSourceModel;
...
/**
 * The contents specifies the source of the data (study and asset) and the rows to include (field and rootValues). TODO: field will move the asset object; it is here as a stepping stone 
 */
@ApiModel(description = "The contents specifies the source of the data (study and asset) and the rows to include (field and rootValues). TODO: field will move the asset object; it is here as a stepping stone ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2019-06-12T09:29:10.549-04:00")
public class DatasetRequestContentsModel {
  @JsonProperty("source")
  private DatasetRequestSourceModel source = null;

  @JsonProperty("rootValues")
  private List<String> rootValues = new ArrayList<>();

  public DatasetRequestContentsModel source(DatasetRequestSourceModel source) {
    this.source = source;
    return this;
  }
  ...
  **/
  ...
  public DatasetRequestSourceModel getSource() {
    return source;
  }

  public void setSource(DatasetRequestSourceModel source) {
    this.source = source;
  }

  public DatasetRequestContentsModel rootValues(List<String> rootValues) {
    this.rootValues = rootValues;
    return this;
  }

  public DatasetRequestContentsModel addRootValuesItem(String rootValuesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DatasetRequestContentsModel datasetRequestContentsModel = (DatasetRequestContentsModel) o;
    return Objects.equals(this.source, datasetRequestContentsModel.source) &&
        Objects.equals(this.rootValues, datasetRequestContentsModel.rootValues);
  }

  @Override
  public int hashCode() {
    return Objects.hash(source, rootValues);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatasetRequestContentsModel {\n");
