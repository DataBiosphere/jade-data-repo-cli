...
public class DRSObject {
  ...
  private List<DRSAccessMethod> accessMethods = new ArrayList<>();
  ...
  **/
  ...
  public DRSObject created(String created) {
  ...
  **/
  ...
  public DRSObject updated(String updated) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The list of access methods that can be used to access the Data Object.")
  ...
  **/
  ...
  public DRSObject addAliasesItem(String aliasesItem) {
   ...
   /**
   * A list of strings that can be used to find other metadata about this Data Object from external metadata sources. These aliases can be used to represent the Data Object&#39;s secondary accession numbers or external GUIDs.
   * @return aliases
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, drSObject.id) &&
        ...
        Objects.equals(this.created, drSObject.created) &&
        Objects.equals(this.updated, drSObject.updated) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, size, created, updated, version, mimeType, checksums, accessMethods, description, aliases);
  }
