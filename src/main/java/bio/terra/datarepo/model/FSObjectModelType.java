...
/**
 * Gets or Sets FSObjectModelType
 */
public enum FSObjectModelType {
  ...
  FSObjectModelType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static FSObjectModelType fromValue(String text) {
    for (FSObjectModelType b : FSObjectModelType.values()) {
