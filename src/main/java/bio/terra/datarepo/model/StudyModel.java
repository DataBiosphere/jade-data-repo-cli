...
import bio.terra.datarepo.model.StudySpecificationModel;
 ...
 */
@ApiModel(description = "Complete definition of a study. ")
...
public class StudyModel {
  ...
  @JsonProperty("defaultDatasetId")
  private String defaultDatasetId = null;

  @JsonProperty("schema")
  private StudySpecificationModel schema = null;

  @JsonProperty("createdDate")
  private String createdDate = null;

  public StudyModel id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public StudyModel name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public StudyModel description(String description) {
  ...
  **/
  ...
  public StudyModel defaultDatasetId(String defaultDatasetId) {
    this.defaultDatasetId = defaultDatasetId;
    return this;
  }

   /**
   * Id of the auto-generated default passthru dataset
   * @return defaultDatasetId
  **/
  @ApiModelProperty(value = "Id of the auto-generated default passthru dataset")
  ...
  public StudyModel schema(StudySpecificationModel schema) {
    this.schema = schema;
    return this;
  }
  ...
  **/
  @ApiModelProperty(required = true, value = "")
  public StudySpecificationModel getSchema() {
    return schema;
  }

  public void setSchema(StudySpecificationModel schema) {
    this.schema = schema;
  }

  public StudyModel createdDate(String createdDate) {
    this.createdDate = createdDate;
    return this;
  }

   /**
   * Date the study was created
   * @return createdDate
  **/
  @ApiModelProperty(required = true, value = "Date the study was created")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StudyModel studyModel = (StudyModel) o;
    return Objects.equals(this.id, studyModel.id) &&
        Objects.equals(this.name, studyModel.name) &&
        Objects.equals(this.description, studyModel.description) &&
        Objects.equals(this.defaultDatasetId, studyModel.defaultDatasetId) &&
        Objects.equals(this.schema, studyModel.schema) &&
        Objects.equals(this.createdDate, studyModel.createdDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, defaultDatasetId, schema, createdDate);
  }
