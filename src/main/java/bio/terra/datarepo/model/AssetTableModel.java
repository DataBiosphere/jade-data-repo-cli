...
/**
 * Used in the asset definition to describe a table that is included in the asset. This is used to define the view of the asset table in the dataset. Columns can be an empty array indicating that all columns should be included. 
 */
@ApiModel(description = "Used in the asset definition to describe a table that is included in the asset. This is used to define the view of the asset table in the dataset. Columns can be an empty array indicating that all columns should be included. ")
