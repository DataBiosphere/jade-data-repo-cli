...
public final class Login {
  ...
  public static void authorize() {
    try {
      List<String> userLoginScopes =
          Arrays.asList(
              "openid", "email", "profile", "https://www.googleapis.com/auth/devstorage.read_only");
  ...
  /**
   * Setter for path to client secrets JSON file. A null value means to use the default path
   * ~/.jadecli/client/jadecli_client_secret.json
   *
